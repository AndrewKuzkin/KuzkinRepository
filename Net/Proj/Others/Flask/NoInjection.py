...
def index():
    if request.method == 'POST':
        ...
        if check_sql_injection(user_input):
            ...
            logging.info(f"SQL Injection detected - IP: {request.remote_addr}, User-Agent: {user_agent}, Input: {user_input}")
        ...
        if check_js_injection(user_input):
            ...
            logging.info(f"JS Injection detected - IP: {request.remote_addr}, User-Agent: {user_agent}, Input: {user_input}")
